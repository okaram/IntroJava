...
initially, loops were promoted as having only one way to get out of it (see footnote:[http://www.cs.utexas.edu/users/EWD/ewd02xx/EWD215.PDF[Goto statement considered harmful]])
=== break
