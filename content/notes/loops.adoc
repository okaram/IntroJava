...
When you are inside a loop, the keyword `break` gets you out of the loop immediately(you normally put it inside the loop). Execution continues right after the body of the loop.
